...
«RusLawOD» — это корпус текстов законодательных актов Российской Федерации и их метаданных за период с 1991 по июль 2026 года. В корпусе собраны все 308,056 текстов (198,777,737 токенов) законов, несекретных федеральных постановлений и актов вместе с их метаданными.
...
Представленный корпус (версия 3.1) состоит из XML-файлов, содержащих тексты законов Российской Федерации, указов Президента РФ, постановлений  Правительства, и другие виды актов, опубликованные по состоянию на июль 2026 г., обновленные из источника 2 августа 2026 г. XML-файлы содержат метаданные, извлеченные из источника, и соответствующие тексты.

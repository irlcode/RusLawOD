...
Если вы используете корпус в ваших научных работах, ссылаться можно на статью [в Вестнике СПбГУ]( https://lawjournal.spbu.ru/article/view/18768) : Кучаков, Р. К., & Савельев, Д. А. (2025). Сложность правовых актов в России: лексическое и синтаксическое качество текстов 1991–2023 годов. Вестник Санкт-Петербургского университета. Право, 16(3), 796–823. ([doi.org/10.21638](https://doi.org/10.21638/)). Также можно сослаться на препринт: The Russian Legislative Corpus. Russian Law Open Data. arXiv preprint [arXiv:2406.04855](https://arxiv.org/abs/2406.04855) (2024).
